...
public class maherDatabase {
	...
	public maherDatabase() throws ClassNotFoundException, SQLException {
	...
	public boolean addStudent(Student s) {
		...
		try {
			result = statement
					.executeUpdate(String.format("insert into "+STUDENT_TABLE+" values(%d, '%s' , %s)", id, name, password));
		} catch (SQLException e) {
			e.printStackTrace();
